    ...
    <div className="flex min-h-screen bg-background text-foreground font-sans selection:bg-section-indigo">
      ...
      `}>
        ...
        <nav className="flex-1 space-y-8 overflow-y-auto">
          <div>
            <div className="section-label px-2 mb-2">
              Arena
            </div>
            <ul className="space-y-1">
              <SidebarItem icon={<Layout size={18} />} label="Overview" active />
          ...
          <div>
            ...
            <ul className="space-y-1">
              <SidebarItem icon={<Calculator size={18} />} label="Mathematics" />
        ...
        <div className="pt-4 border-t border-border">
          <button className="flex items-center gap-3 px-2 py-2 w-full hover:bg-secondary rounded-lg transition-colors text-sm font-medium text-muted-foreground">
            <Settings size={18} />
            <span>Settings</span>
          </button>
        </div>
            ...
            <div className="bg-card pl-1 pr-4 sm:pr-6 py-1 rounded-full border border-border shadow-sm flex items-center gap-3 sm:gap-4 hover:shadow-md transition-shadow cursor-pointer w-full sm:w-auto">
              ...
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center shrink-0">
                <svg className="w-full h-full transform -rotate-90">
                  <circle cx="50%" cy="50%" r="40%" stroke="var(--muted)" strokeWidth="3" fill="transparent" />
                  <circle cx="50%" cy="50%" r="40%" stroke="var(--primary)" strokeWidth="3" fill="transparent" strokeDasharray="138" strokeDashoffset="30" strokeLinecap="round" />
                </svg>
              ...
              <div className="flex flex-col min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-bold text-foreground">Level 42</span>
                  <span className="px-1.5 py-0.5 rounded bg-muted text-[10px] font-bold text-muted-foreground border border-border">240 XP</span>
                </div>
                <span className="text-xs text-muted-foreground font-serif italic truncate">Grandmaster League</span>
              </div>
            </div>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6">
            ...
            <div className="md:col-span-2 lg:col-span-8 bg-linear-to-br from-section-blue to-section-purple rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-sm border border-white/50 relative overflow-hidden group cursor-pointer transition-transform hover:scale-[1.005] duration-300">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  <button className="bg-primary text-primary-foreground px-5 sm:px-6 py-2.5 rounded-xl font-medium text-sm hover:bg-primary-hover transition-colors shadow-lg shadow-primary/10 flex items-center gap-2 w-full sm:w-auto justify-center">
                    <Swords size={16} />
                    Find Ranked Match
                  </button>
                  <div className="flex items-center gap-3">
                    <div className="flex -space-x-2">
                      <div className="w-8 h-8 rounded-full bg-card border-2 border-section-blue flex items-center justify-center text-[10px] font-bold text-muted-foreground">You</div>
                    ...
                    <span className="text-xs text-muted-foreground font-medium">1,204 online</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 bg-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-sm border border-border flex flex-col justify-between">
              <div className="flex justify-between items-start">
                <h3 className="font-serif text-lg text-foreground">Global Rank</h3>
              ...
              <div className="flex items-center justify-center py-4">
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 flex items-center justify-center">
                  <svg className="w-full h-full transform -rotate-90">
                    <circle cx="50%" cy="50%" r="44%" stroke="var(--muted)" strokeWidth="12" fill="transparent" />
                    <circle cx="50%" cy="50%" r="44%" stroke="var(--warning)" strokeWidth="12" fill="transparent" strokeDasharray="351" strokeDashoffset="35" strokeLinecap="round" />
                  </svg>
                  <div className="absolute flex flex-col items-center">
                    <span className="text-2xl sm:text-3xl font-serif font-bold text-foreground">#42</span>
                    <span className="text-[10px] text-muted-foreground uppercase tracking-wide font-bold">Top 1%</span>
                  </div>
                </div>
              </div>

              <div className="text-center">
                <p className="text-sm text-muted-foreground">Tier: <span className="text-warning font-bold">Grandmaster</span></p>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 bg-section-yellow rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-sm border border-warning/20 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-warning/20 rounded">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-foreground/80 leading-snug">Review 3 missed organic chemistry reactions</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 min-w-4 h-4 border-2 border-warning/30 rounded flex items-center justify-center shrink-0">
                    <Zap size={12} className="text-warning" />
                  </div>
                  <span className="text-sm text-muted-foreground leading-snug">Calculus integration speed improved by 15%</span>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-4 bg-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-sm border border-border">
              <h3 className="font-serif text-lg text-foreground mb-4">Subject Ratings</h3>
              <div className="space-y-4">
                <EloItem icon={<Calculator size={16} />} subject="Mathematics" elo="1,450" color="blue" />
                <EloItem icon={<Atom size={16} />} subject="Physics" elo="1,320" color="purple" />
                <EloItem icon={<Beaker size={16} />} subject="Chemistry" elo="1,105" color="orange" />
                <EloItem icon={<Dna size={16} />} subject="Biology" elo="1,180" color="green" />
              </div>
            </div>
            ...
            <div className="lg:col-span-4 bg-section-purple rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-sm border border-accent-purple/20 flex flex-col justify-center relative overflow-hidden">
              <div className="relative z-10">
                ...
                <h3 className="font-serif text-lg text-foreground mb-1">Weekly Tournament</h3>
                <p className="text-xs text-muted-foreground mb-4">"Science Olympiad" starts in 2 hours.</p>
                <button className="text-xs font-bold uppercase tracking-wide text-accent-purple flex items-center gap-1 hover:gap-2 transition-all">
            ...
            <div className="md:col-span-2 lg:col-span-12 mt-4 sm:mt-6">
              <div className="flex items-center justify-between mb-6 sm:mb-8">
                <h3 className="font-serif text-lg text-foreground">Match Timeline</h3>
              ...
              <div className="sm:hidden">
                <div className="relative pl-8">
                  ...
                  <div className="space-y-6">
                    <MobileTimelineNode result="W" elo="+24" icon={<Atom size={14} />} subject="Physics" color="purple" opponent="Alex" />
                    <MobileTimelineNode result="L" elo="-12" icon={<Calculator size={14} />} subject="Maths" color="blue" opponent="Sarah" />
                    <MobileTimelineNode result="W" elo="+18" icon={<Dna size={14} />} subject="Biology" color="green" opponent="Dave" />
                    <MobileTimelineNode result="W" elo="+32" icon={<Beaker size={14} />} subject="Chem" color="orange" opponent="Mark" />
...
const SidebarItem = ({ icon, label, active = false }: { icon: React.ReactNode, label: string, active?: boolean }) => (
  <li className={`flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200 group ${active ? 'bg-secondary text-foreground' : 'text-muted-foreground hover:bg-muted hover:text-foreground'}`}>
    <span className={`${active ? 'text-foreground' : 'text-muted-foreground group-hover:text-foreground'}`}>{icon}</span>
    <span className="text-sm font-medium">{label}</span>
  </li>
);

const EloItem = ({ icon, subject, elo, color }: { icon: React.ReactNode, subject: string, elo: string, color: 'blue' | 'purple' | 'orange' | 'green' }) => {
  const colors = {
    ...
    <div className="flex items-center gap-4 group cursor-pointer">
      ...
      <div className="flex-1 py-1 min-w-0">
        <div className="flex justify-between items-center">
          ...
          <span className="font-mono font-bold text-foreground text-sm ml-2">{elo}</span>
        </div>
        <div className="w-full bg-muted rounded-full h-1.5 mt-2 overflow-hidden">
          <div className={`h-1.5 rounded-full ${bars[color]}`} style={{ width: '70%' }}></div>
        </div>
      </div>
    </div>
  );
...
const TimelineNode = ({ result, elo, icon, subject, color, opponent }: {
  result: string;
  elo: string;
  ...
  const colors = {
    ...
    orange: 'text-subject-chemistry bg-section-amber border-subject-chemistry/30',
  };
  ...
  return (
    <div className="group relative flex flex-col items-center cursor-pointer">
      ...
      <div className="absolute bottom-full mb-3 opacity-0 group-hover:opacity-100 transition-all duration-200">
        <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md shadow-sm border whitespace-nowrap ${colors[color]}`}>
          {subject}
        </span>
      </div>

      {/* The Node */}
      <div className={`w-10 h-10 rounded-full bg-card border-2 flex items-center justify-center relative z-10 transition-all duration-200 group-hover:scale-110 shadow-sm ${result === 'W' ? 'border-border' : 'border-destructive/30 bg-destructive/5'}`}>
        <div className={result === 'W' ? 'text-foreground' : 'text-destructive'}>
          {icon}
        </div>
      </div>
      ...
      <div className="mt-3 text-center">
        ...
        <span className={`font-mono text-xs font-bold ${elo.includes('+') ? 'text-success' : 'text-destructive'}`}>{elo}</span>
        <div className="text-[10px] text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity">vs {opponent}</div>
      </div>
    </div>
  );
};
...
const MobileTimelineNode = ({ result, elo, icon, subject, color, opponent }: {
  result: string;
  elo: string;
  icon: React.ReactNode;
  subject: string;
  ...
  return (
    <div className="flex items-center gap-4">
      {/* Node */}
      <div className={`w-8 h-8 rounded-full bg-card border-2 flex items-center justify-center shrink-0 -ml-4 ${result === 'W' ? 'border-border' : 'border-destructive/30 bg-destructive/5'}`}>
        <div className={result === 'W' ? 'text-foreground' : 'text-destructive'}>
          {icon}
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-between bg-card rounded-xl p-3 border border-border">
        <div className="flex items-center gap-3">
          <span className={`text-xs font-bold px-2 py-0.5 rounded ${colors[color]}`}>{subject}</span>
          <span className="text-sm text-muted-foreground">vs {opponent}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className={`font-mono text-sm font-bold ${elo.includes('+') ? 'text-success' : 'text-destructive'}`}>{elo}</span>
          <span className={`text-sm font-bold ${result === 'W' ? 'text-foreground' : 'text-destructive'}`}>{result}</span>
        </div>
      </div>
    </div>
  );
